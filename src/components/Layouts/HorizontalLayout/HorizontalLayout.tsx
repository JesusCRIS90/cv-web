...
import { POLICY_HORIZONTAL_POSITION } from "../../../utils/enums"
...
interface BaseProps extends React.PropsWithChildren {
    ...
    className?: string,
    style?: CSSProperties,
    groupPolicyPos?: POLICY_HORIZONTAL_POSITION
    gap?: number,
}
...
function BuildCustomStyle(groupPolicyPos: POLICY_HORIZONTAL_POSITION, Gap: number, userCustomStyle: Object): CSSProperties {
    ...
    switch (groupPolicyPos) {
        ...
        case POLICY_HORIZONTAL_POSITION.TOP_LEFT:
            alignItems = "flex-start";
            justifyContent = "flex-start";
            break;

        case POLICY_HORIZONTAL_POSITION.TOP_CENTER:
            alignItems = "flex-start";
            justifyContent = "center";
            break;

        case POLICY_HORIZONTAL_POSITION.TOP_RIGHT:
            alignItems = "flex-start";
            justifyContent = "flex-end";
            break;

        case POLICY_HORIZONTAL_POSITION.CENTER_LEFT:
            alignItems = "center";
            justifyContent = "flex-start";
            break;

        case POLICY_HORIZONTAL_POSITION.CENTER_CENTER:
            alignItems = "center";
            justifyContent = "center";
            break;

        case POLICY_HORIZONTAL_POSITION.CENTER_RIGHT:
            alignItems = "center";
            justifyContent = "flex-end";
            break;

        case POLICY_HORIZONTAL_POSITION.BOTTOM_LEFT:
            alignItems = "flex-end";
            justifyContent = "flex-start";
            break;

        case POLICY_HORIZONTAL_POSITION.BOTTOM_CENTER:
            alignItems = "flex-end";
            justifyContent = "center";
            break;

        case POLICY_HORIZONTAL_POSITION.BOTTOM_RIGHT:
            alignItems = "flex-end";
            justifyContent = "flex-end";
            break;
...
const HorizontalLayout: React.FC<HorizontalLayoutProps> = ({
    ...
    className = "",
    style = {},
    groupPolicyPos = POLICY_HORIZONTAL_POSITION.CENTER_CENTER,
    gap = 0,
    data = {}
}) => {
